...
export const metadata: Metadata = {
  title: "Cleanser - PureGlow Webflow Ecommerce Website Template",
  description: "Browse Cleanser products at PureGlow. Discover quality essentials with detailed descriptions and competitive pricing. Shop now!",
};
