...
export const metadata: Metadata = {
  title: "Toner - PureGlow Webflow Ecommerce Website Template",
  description: "Browse Toner products at PureGlow. Discover quality essentials with detailed descriptions and competitive pricing. Shop now!",
};
