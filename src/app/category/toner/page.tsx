...
export const metadata: Metadata = {
  title: "Toner - Nuvera Webflow Ecommerce Website Template",
  description: "Browse Toner products at Nuvera. Discover quality essentials with detailed descriptions and competitive pricing. Shop now!",
};
