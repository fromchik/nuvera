...
export const metadata: Metadata = {
  title: "Serum - PureGlow Webflow Ecommerce Website Template",
  description: "Browse Serum products at PureGlow. Discover quality essentials with detailed descriptions and competitive pricing. Shop now!",
};
