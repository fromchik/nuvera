...
export const metadata: Metadata = {
  title: "Moisturiser - Nuvera Webflow Ecommerce Website Template",
  description: "Browse Moisturiser products at Nuvera. Discover quality essentials with detailed descriptions and competitive pricing. Shop now!",
};
