...
export const metadata: Metadata = {
  title: "SPF - PureGlow Webflow Ecommerce Website Template",
  description: "Browse SPF products at PureGlow. Discover quality essentials with detailed descriptions and competitive pricing. Shop now!",
};
