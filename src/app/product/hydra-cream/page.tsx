...
export const metadata: Metadata = {
  title: "Hydra Cream - Nuvera Webflow Ecommerce Website Template",
  description: "Hydra Cream delivers 24-hour deep hydration with ceramides, squalane, and shea butter for a soft, plump, and nourished skin barrier",
};
