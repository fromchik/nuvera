...
export const metadata: Metadata = {
  title: "Soft Skin Body Lotion - Nuvera Webflow Ecommerce Website Template",
  description: "Soft Skin Body Lotion deeply hydrates with shea butter, aloe vera, and vitamin E for silky smooth, nourished, and glowing skin all day",
};
