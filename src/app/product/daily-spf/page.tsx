...
export const metadata: Metadata = {
  title: "Daily SPF - Nuvera Webflow Ecommerce Website Template",
  description: "Daily SPF is a lightweight mineral SPF 50 with zinc oxide and niacinamide for broad-spectrum UV protection and a matte finish.",
};
