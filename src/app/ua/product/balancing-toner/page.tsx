...
export const metadata: Metadata = {
  title: "Балансувальний тонер - Nuvera, шаблон інтернет-магазину Webflow",
  description: "Balancing Toner — це безалкогольна формула з центелою азійською та трояндовою водою, яка зволожує та готує шкіру після кожного очищення.",
};
