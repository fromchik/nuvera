...
export const metadata: Metadata = {
  title: "Відновлювальний бальзам - Nuvera, шаблон інтернет-магазину Webflow",
  description: "Rescue Balm відновлює та заспокоює чутливу шкіру завдяки церамідам і центелі азійській, забезпечуючи глибоке зволоження та відновлений шкірний бар’єр.",
};
