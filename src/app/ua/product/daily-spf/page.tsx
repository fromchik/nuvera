...
export const metadata: Metadata = {
  title: "Щоденний SPF - Nuvera, шаблон інтернет-магазину Webflow",
  description: "Daily SPF — це легкий мінеральний SPF 50 з оксидом цинку та ніацинамідом для широкого захисту від УФ-випромінювання та матового фінішу.",
};
