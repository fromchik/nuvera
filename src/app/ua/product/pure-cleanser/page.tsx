...
export const metadata: Metadata = {
  title: "Очищувальний засіб Pure - Nuvera, шаблон інтернет-магазину Webflow",
  description: "Pure Cleanser — це м’яка безсульфатна пінка, яка видаляє забруднення та макіяж, не позбавляючи шкіру природної вологи.",
};
