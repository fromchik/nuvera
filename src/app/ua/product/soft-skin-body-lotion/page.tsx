...
export const metadata: Metadata = {
  title: "Лосьйон для тіла Soft Skin - Nuvera, шаблон інтернет-магазину Webflow",
  description: "Soft Skin Body Lotion глибоко зволожує завдяки маслу ши, алое вера та вітаміну E, роблячи шкіру шовковистою, насиченою та сяйливою впродовж усього дня.",
};
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M2.55806 6.29544C2.46043 6.19781 2.46043 6.03952 2.55806 5.94189L3.44195 5.058C3.53958 4.96037 3.69787 4.96037 3.7955 5.058L8.00001 9.26251L12.2045 5.058C12.3021 4.96037 12.4604 4.96037 12.5581 5.058L13.4419 5.94189C13.5396 6.03952 13.5396 6.19781 13.4419 6.29544L8.17678 11.5606C8.07915 11.6582 7.92086 11.6582 7.82323 11.5606L2.55806 6.29544Z" fill="currentColor"/>
  ...
  <path d="M5 12h14"></path>
  <path d="M12 5v14"></path>
</svg></div></div></div></a></div></div></div></div><div class="related-product_slide w-slide"><div class="related-product_list-wrapper w-dyn-list"><div role="list" class="related-product_list w-dyn-items"><div role="listitem" class="related-product-item w-dyn-item"><a data-hover-trigger="scale-up" href="/ua/product/pure-cleanser" class="product_card w-inline-block"><img width="Auto" data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_main_image_4dr%22%2C%22to%22%3A%22src%22%7D%5D" alt="Pure Cleanser foam bottle for gentle deep cleansing and clear skin" loading="lazy" src="/webflow/cdn.prod.website-files.com/69c386bec1311dc1f168dff2/69d965dab9e45b01ceb24ae5_cleanser11.avif" data-hover-target="scale-up" class="product_card-image"/><div class="overlay"></div><div class="product_price-wrap"><div data-wf-sku-bindings="%5B%7B%22from%22%3A%22f_price_%22%2C%22to%22%3A%22innerHTML%22%7D%5D" class="product_card-price">$ 500.00 USD</div></div><div class="product_card-bottom"><p class="product_title">Очищувальний засіб Pure</p><div class="product-card_cart-icon-wrapper"><div class="product-plus-icon w-embed"><svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  <path d="M5 12h14"></path>
  <path d="M12 5v14"></path>
