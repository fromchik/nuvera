...
export const metadata: Metadata = {
  title: "Сироватка Glow - Nuvera, шаблон інтернет-магазину Webflow",
  description: "Glow Serum освітлює та вирівнює тон шкіри завдяки 15% вітаміну C, гіалуроновій кислоті та ніацинаміду, забезпечуючи помітне сяйво вже за 2 тижні.",
};
