...
export const metadata: Metadata = {
  title: "Крем Hydra - Nuvera, шаблон інтернет-магазину Webflow",
  description: "Hydra Cream забезпечує глибоке зволоження на 24 години завдяки церамідам, сквалану та маслу ши, роблячи шкірний бар’єр м’яким, пружним і насиченим.",
};
