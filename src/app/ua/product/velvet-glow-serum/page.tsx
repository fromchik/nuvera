...
export const metadata: Metadata = {
  title: "Сироватка Velvet Glow - Nuvera, шаблон інтернет-магазину Webflow",
  description: "Velvet Glow Serum глибоко живить і зволожує шкіру до 24 годин, повертаючи природне сяйво завдяки легким натуральним екстрактам.",
};
