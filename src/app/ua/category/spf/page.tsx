...
export const metadata: Metadata = {
  title: "SPF - PureGlow, шаблон інтернет-магазину Webflow",
  description: "Переглядайте SPF-засоби PureGlow. Відкрийте якісні товари з докладними описами та чесними цінами. Купуйте зараз!",
};
