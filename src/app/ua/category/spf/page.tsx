...
export const metadata: Metadata = {
  title: "SPF - Nuvera, шаблон інтернет-магазину Webflow",
  description: "Переглядайте SPF-засоби Nuvera. Відкрийте якісні товари з докладними описами та чесними цінами. Купуйте зараз!",
};
