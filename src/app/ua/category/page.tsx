...
export const metadata: Metadata = {
  title: "Категорія - PureGlow, шаблон інтернет-магазину Webflow",
  description: "Перегляньте повну beauty-колекцію PureGlow. Купуйте засоби за категоріями: сироватки, очищення, зволоження, SPF, лосьйони, тонери та багато іншого.",
};
