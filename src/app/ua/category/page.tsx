...
export const metadata: Metadata = {
  title: "Категорія - Nuvera, шаблон інтернет-магазину Webflow",
  description: "Перегляньте повну beauty-колекцію Nuvéra. Купуйте засоби за категоріями: сироватки, очищення, зволоження, SPF, лосьйони, тонери та багато іншого.",
};
