...
export const metadata: Metadata = {
  title: "Зволоження - Nuvera, шаблон інтернет-магазину Webflow",
  description: "Переглядайте зволожувальні засоби Nuvera. Відкрийте якісні товари з докладними описами та чесними цінами. Купуйте зараз!",
};
