...
export const metadata: Metadata = {
  title: "Зволоження - PureGlow, шаблон інтернет-магазину Webflow",
  description: "Переглядайте зволожувальні засоби PureGlow. Відкрийте якісні товари з докладними описами та чесними цінами. Купуйте зараз!",
};
