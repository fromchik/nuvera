...
export const metadata: Metadata = {
  title: "Очищення - PureGlow, шаблон інтернет-магазину Webflow",
  description: "Переглядайте засоби для очищення PureGlow. Відкрийте якісні товари з докладними описами та чесними цінами. Купуйте зараз!",
};
