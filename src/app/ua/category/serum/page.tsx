...
export const metadata: Metadata = {
  title: "Сироватка - Nuvera, шаблон інтернет-магазину Webflow",
  description: "Переглядайте сироватки Nuvera. Відкрийте якісні товари з докладними описами та чесними цінами. Купуйте зараз!",
};
