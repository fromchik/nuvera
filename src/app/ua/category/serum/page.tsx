...
export const metadata: Metadata = {
  title: "Сироватка - PureGlow, шаблон інтернет-магазину Webflow",
  description: "Переглядайте сироватки PureGlow. Відкрийте якісні товари з докладними описами та чесними цінами. Купуйте зараз!",
};
