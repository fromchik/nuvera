...
export const metadata: Metadata = {
  title: "Політика конфіденційності - Nuvera, шаблон інтернет-магазину Webflow",
  description: "Дізнайтеся, як Nuvéra збирає, використовує та захищає вашу особисту інформацію. Прочитайте нашу політику конфіденційності про безпеку даних, cookie та ваші права.",
};
