...
export const metadata: Metadata = {
  title: "Політика конфіденційності - PureGlow, шаблон інтернет-магазину Webflow",
  description: "Дізнайтеся, як PureGlow збирає, використовує та захищає вашу особисту інформацію. Прочитайте нашу політику конфіденційності про безпеку даних, cookie та ваші права.",
};
