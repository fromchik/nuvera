...
export const metadata: Metadata = {
  title: "Скидання пароля - Nuvera, шаблон інтернет-магазину Webflow",
  description: "Скиньте пароль акаунта Nuvéra. Введіть email, щоб отримати безпечне посилання для скидання та відновити доступ до акаунта.",
};
