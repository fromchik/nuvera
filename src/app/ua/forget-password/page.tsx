...
export const metadata: Metadata = {
  title: "Скидання пароля - PureGlow, шаблон інтернет-магазину Webflow",
  description: "Скиньте пароль акаунта PureGlow. Введіть email, щоб отримати безпечне посилання для скидання та відновити доступ до акаунта.",
};
