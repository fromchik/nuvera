...
export const metadata: Metadata = {
  title: "Реєстрація - PureGlow, шаблон інтернет-магазину Webflow",
  description: "Приєднуйтеся до PureGlow Beauty, щоб зберігати обране, відстежувати замовлення та отримувати ранній доступ до нових колекцій. Реєструйтеся заради ексклюзивних пропозицій і безпечних покупок.",
};
