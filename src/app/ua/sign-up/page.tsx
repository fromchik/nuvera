...
export const metadata: Metadata = {
  title: "Реєстрація - Nuvera, шаблон інтернет-магазину Webflow",
  description: "Приєднуйтеся до Nuvéra Beauty, щоб зберігати обране, відстежувати замовлення та отримувати ранній доступ до нових колекцій. Реєструйтеся заради ексклюзивних пропозицій і безпечних покупок.",
};
