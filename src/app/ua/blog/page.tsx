...
export const metadata: Metadata = {
  title: "Блог - Nuvera, шаблон інтернет-магазину Webflow",
  description: "Дізнавайтеся про свіжі поради з догляду за шкірою, ідеї clean beauty та експертні рекомендації щодо рослинних інгредієнтів для здорової й збалансованої шкіри.",
};
