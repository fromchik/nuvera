...
export const metadata: Metadata = {
  title: "Гайд зі стилю - PureGlow, шаблон інтернет-магазину Webflow",
  description: "Ознайомтеся з бренд-гайдом PureGlow: палітрою кольорів, шкалою типографіки та варіантами кнопок. Повна документація дизайн-системи.",
};
