...
export const metadata: Metadata = {
  title: "Гайд зі стилю - Nuvera, шаблон інтернет-магазину Webflow",
  description: "Ознайомтеся з бренд-гайдом Nuvéra: палітрою кольорів, шкалою типографіки та варіантами кнопок. Повна документація дизайн-системи.",
};
