...
export const metadata: Metadata = {
  ...
  description: "Перегляньте останні оновлення, покращення та виправлення Nuvéra Beauty. Відстежуйте покращення сайту, багфікси та нові функції від запуску до сьогодні.",
};
