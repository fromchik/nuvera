...
export const metadata: Metadata = {
  title: "Вхід - PureGlow, шаблон інтернет-магазину Webflow",
  description: "Увійдіть до акаунта PureGlow, щоб отримати доступ до замовлень, нотаток і персоналізованих beauty-рекомендацій. Безпечний зашифрований вхід.",
};
