...
export const metadata: Metadata = {
  title: "Вхід - Nuvera, шаблон інтернет-магазину Webflow",
  description: "Увійдіть до акаунта Nuvéra, щоб отримати доступ до замовлень, нотаток і персоналізованих beauty-рекомендацій. Безпечний зашифрований вхід.",
};
