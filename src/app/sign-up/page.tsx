...
export const metadata: Metadata = {
  title: "Sign Up - PureGlow Webflow Ecommerce Website Template",
  description: "Join PureGlow Beauty to save favorites, track orders, and get early access to new collections. Sign up for exclusive offers and secure shopping.",
};
