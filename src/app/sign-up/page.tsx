...
export const metadata: Metadata = {
  title: "Sign Up - Nuvera Webflow Ecommerce Website Template",
  description: "Join Nuvéra Beauty to save favorites, track orders, and get early access to new collections. Sign up for exclusive offers and secure shopping.",
};
