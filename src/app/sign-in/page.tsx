...
export const metadata: Metadata = {
  title: "Sign In - PureGlow Webflow Ecommerce Website Template",
  description: "Sign in to your PureGlow account to access orders, styling notes, and personalized beauty recommendations. Secure encrypted login.",
};
