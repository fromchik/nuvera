...
export const metadata: Metadata = {
  title: "Sign In - Nuvera Webflow Ecommerce Website Template",
  description: "Sign in to your Nuvéra account to access orders, styling notes, and personalized beauty recommendations. Secure encrypted login.",
};
