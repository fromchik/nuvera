...
export const metadata: Metadata = {
  title: "Style Guide - Nuvera Webflow Ecommerce Website Template",
  description: "Explore Nuvéra&#x27;s brand style guide including color palette, typography scale, and button variants. Complete design system documentation.",
};
