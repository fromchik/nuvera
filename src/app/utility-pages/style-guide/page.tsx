...
export const metadata: Metadata = {
  title: "Style Guide - PureGlow Webflow Ecommerce Website Template",
  description: "Explore PureGlow&#x27;s brand style guide including color palette, typography scale, and button variants. Complete design system documentation.",
};
