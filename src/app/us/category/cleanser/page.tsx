...
export const metadata: Metadata = {
  title: "Cleanser - Nuvera Webflow Ecommerce Website Template",
  description: "Browse Cleanser products at Nuvera. Discover quality essentials with detailed descriptions and competitive pricing. Shop now!",
};
