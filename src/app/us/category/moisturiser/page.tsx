...
export const metadata: Metadata = {
  title: "Moisturiser - PureGlow Webflow Ecommerce Website Template",
  description: "Browse Moisturiser products at PureGlow. Discover quality essentials with detailed descriptions and competitive pricing. Shop now!",
};
