...
export const metadata: Metadata = {
  title: "SPF - Nuvera Webflow Ecommerce Website Template",
  description: "Browse SPF products at Nuvera. Discover quality essentials with detailed descriptions and competitive pricing. Shop now!",
};
