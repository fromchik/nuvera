...
export const metadata: Metadata = {
  title: "Serum - Nuvera Webflow Ecommerce Website Template",
  description: "Browse Serum products at Nuvera. Discover quality essentials with detailed descriptions and competitive pricing. Shop now!",
};
