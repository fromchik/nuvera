...
export const metadata: Metadata = {
  title: "Velvet Glow Serum - Nuvera Webflow Ecommerce Website Template",
  description: "Velvet Glow Serum deeply nourishes and hydrates skin for up to 24 hours, restoring your natural glow with lightweight natural extracts.",
};
