...
export const metadata: Metadata = {
  title: "Balancing Toner - Nuvera Webflow Ecommerce Website Template",
  description: "Balancing Toner is an alcohol-free formula with centella asiatica and rose water that hydrates and preps skin after every cleanse.",
};
