...
export const metadata: Metadata = {
  title: "Dew Glow Moisturizer - Nuvera Webflow Ecommerce Website Template",
  description: "Dew Glow Moisturizer is a lightweight gel-cream with niacinamide and green tea for a fresh, dewy, and healthy glow all day.",
};
