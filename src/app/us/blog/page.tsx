...
export const metadata: Metadata = {
  title: "Blog - Nuvera Webflow Ecommerce Website Template",
  description: "Discover the latest skincare tips, clean beauty insights, and expert advice on plant-based ingredients for healthy, balanced skin.",
};
