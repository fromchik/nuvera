...
export const metadata: Metadata = {
  ...
  description: "View the latest updates, improvements, and fixes for Nuvéra Beauty. Track site enhancements, bug fixes, and new features from launch to present.",
};
