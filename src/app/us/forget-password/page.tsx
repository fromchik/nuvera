...
export const metadata: Metadata = {
  title: "Forget Password - PureGlow Webflow Ecommerce Website Template",
  description: "Reset your PureGlow account password. Enter your email to receive a secure password reset link and regain access to your account.",
};
