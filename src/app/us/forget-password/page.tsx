...
export const metadata: Metadata = {
  title: "Forget Password - Nuvera Webflow Ecommerce Website Template",
  description: "Reset your Nuvéra account password. Enter your email to receive a secure password reset link and regain access to your account.",
};
